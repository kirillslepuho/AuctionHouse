...
public class PlaceEnglishBet implements ICommand{
	...
	private static final Logger logger = LogManager.getLogger(PlaceEnglishBet.class.getName());

	/**
	 * Gets client id, auction id and bet from the request parameters and passes them to the placeEnglishBet method in the ClientService, redirect to referer.
	 *
