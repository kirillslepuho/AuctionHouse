				...
				<div class="panel panel-default">
					<div class="panel-body">
						...
						<form role="form" method="post" action="javascript:void(null);"
							...
							<input type="hidden" id="edit-lot-change-id" value="${requestScope.id}" />
								<label>${lotName}</label> <input type="text"
									class="form-control" id="edit-lot-lot-name" value="${lot.name}">
							</div>
							<div class="top-margin">
							...
							<div class="top-margin">
								<label>${currentPrice}</label> <input type="text"
									class="form-control" id="edit-lot-current-price" value="${lot.currentPrice}">
							</div>
							<div class="top-margin">
								<label>${description}</label> <input type="text"
									class="form-control" id="edit-lot-description" value="${lot.descriprion}">
							</div>
							<div class="top-margin">
